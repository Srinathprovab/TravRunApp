//
//  ModifyHotelViewController.swift
//  Travrun
//
//  Created by MA1882 on 15/03/24.
//

import UIKit

class ModifyHotelViewController: BaseTableVC, TopFlightDetailsViewModelDelegate {
    ...
    static var newInstance: ModifyHotelViewController? {
        let storyboard = UIStoryboard(name: Storyboard.SearchHotel.name,
                                      bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: self.className()) as? ModifyHotelViewController
        return vc
    }
...
//        tablerow.append(TableRow(height:16, cellType:.EmptyTVCell))
    ...
    func gotoSearchHotelsResultVC(){
        ...
        vc.isvcfrom = "ModifyHotelViewController"
...
extension ModifyHotelViewController {
