...
class AddDeatilsOfGuestTVCell: TableViewCell {
    ...
    func setAttributedText(str1:String,str2:String)  {
        ...
        let atter2 = [NSAttributedString.Key.foregroundColor: HexColor("#3C627A"),NSAttributedString.Key.font:UIFont.InterRegular(size: 10)] as [NSAttributedString.Key : Any]
